...
import org.verselstudios.world.StaticPhysicsObject;
import physx.geometry.PxBoxGeometry;
import physx.physics.*;

public class StaticBox extends StaticPhysicsObject {
    ...
    public StaticBox(Transform modelTransform, Vector3d radius, Texture texture, Material material, PxMaterial pxMaterial) {
